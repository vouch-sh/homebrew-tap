class Vouch < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/vouch-sh/vouch/releases/download/v2026.2.16/vouch-v2026.2.16-aarch64-apple-darwin.tar.gz"
      sha256 "bf24359abbf2741f6893520edbc6e520107c3cecdf8af1ba507ec484a6199ea5"
    end
  end
