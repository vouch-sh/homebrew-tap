class Vouch < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/vouch-sh/vouch/releases/download/v2026.2.36/vouch-v2026.2.36-aarch64-apple-darwin.tar.gz"
      sha256 "771dcdb0d4cd7994256e77a294d51a2e4578ebe9b06b46b02b13e1c79f566a60"
    end
  end
