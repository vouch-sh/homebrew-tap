class Vouch < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/vouch-sh/vouch/releases/download/v2026.4.5/vouch-v2026.4.5-aarch64-apple-darwin.tar.gz"
      sha256 "2ce5b9d54fc96490cd71fe01123e8399418d6bf588ce36f72df5bd0962484eb1"
    end
  end
