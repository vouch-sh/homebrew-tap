class Vouch < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/vouch-sh/vouch/releases/download/v2026.5.1/vouch-v2026.5.1-aarch64-apple-darwin.tar.gz"
      sha256 "d21133b8f1d7ba219149f4ed13db78e498e99651674d748c9a9a2a2340147433"
    end
  end
