class Vouch < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/vouch-sh/vouch/releases/download/v2026.2.39/vouch-v2026.2.39-aarch64-apple-darwin.tar.gz"
      sha256 "5eee52cac6ce9579d5c924fcd28faacda6f40b5972babeb70ebf73db89316851"
    end
  end
