class Vouch < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/vouch-sh/vouch/releases/download/v2026.2.7/vouch-v2026.2.7-aarch64-apple-darwin.tar.gz"
      sha256 "8ed564735b88a0042e6d51374cd2eb33bc923705e7f94b56e3cd99d6771cbd85"
    end
  end
