class Vouch < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/vouch-sh/vouch/releases/download/v2026.3.19/vouch-v2026.3.19-aarch64-apple-darwin.tar.gz"
      sha256 "9c179e258e03b6c42e1418a947db9531f99136952f9b483623a57516a3652082"
    end
  end
