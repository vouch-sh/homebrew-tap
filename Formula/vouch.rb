class Vouch < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/vouch-sh/vouch/releases/download/v2026.2.31/vouch-v2026.2.31-aarch64-apple-darwin.tar.gz"
      sha256 "318b34c136a99dfde70d2442eb5bc21ec7e103425f7516a6dbcbfc5db4141758"
    end
  end
