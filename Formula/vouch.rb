class Vouch < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/vouch-sh/vouch/releases/download/v2026.2.42/vouch-v2026.2.42-aarch64-apple-darwin.tar.gz"
      sha256 "e5e8c563378c7dc0653fd3dbc1b076446a3f787b11ff6e8bdcdfd466e90b94ce"
    end
  end
