class Vouch < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/vouch-sh/vouch/releases/download/v2026.2.10/vouch-v2026.2.10-aarch64-apple-darwin.tar.gz"
      sha256 "57b4297dfc3917dcfb5dd2eab65f2c048794cb64dff23dcfa2f2a98a38605495"
    end
  end
