class Vouch < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/vouch-sh/vouch/releases/download/v2026.3.4/vouch-v2026.3.4-aarch64-apple-darwin.tar.gz"
      sha256 "2f417522c6cbd814736de52fbb34a25766adedace1163ec0f14f0c267fa85639"
    end
  end
