class Vouch < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/vouch-sh/vouch/releases/download/v2026.3.6/vouch-v2026.3.6-aarch64-apple-darwin.tar.gz"
      sha256 "e0209868311f486a69c64a284d937fbce6abbe75b993689d2412264dcbb203cb"
    end
  end
