class Vouch < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/vouch-sh/vouch/releases/download/v2026.6.3/vouch-v2026.6.3-aarch64-apple-darwin.tar.gz"
      sha256 "0f6f1c23c4b9c54bd034a78c0e39ecc64f6bcf0eeb44daa3519603cd9eef976b"
    end
  end
