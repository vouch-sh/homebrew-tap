class Vouch < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/vouch-sh/vouch/releases/download/v2026.3.17/vouch-v2026.3.17-aarch64-apple-darwin.tar.gz"
      sha256 "865fa1344fcde99cb0d9768203b778250dde63c076c82e27cf80a9571adc58ba"
    end
  end
