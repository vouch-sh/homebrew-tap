class Vouch < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/vouch-sh/vouch/releases/download/v2026.3.18/vouch-v2026.3.18-aarch64-apple-darwin.tar.gz"
      sha256 "6869648b3e012a91265dbcd7b386926aa7034edcc81536a0ca94e5049f1aa692"
    end
  end
