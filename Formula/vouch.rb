class Vouch < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/vouch-sh/vouch/releases/download/v2026.2.40/vouch-v2026.2.40-aarch64-apple-darwin.tar.gz"
      sha256 "0af015d17db6e35034877d98284b81e962f1da4ce9753b7f8a16a26074c1c334"
    end
  end
