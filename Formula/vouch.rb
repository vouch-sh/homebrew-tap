class Vouch < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/vouch-sh/vouch/releases/download/v2026.4.1/vouch-v2026.4.1-aarch64-apple-darwin.tar.gz"
      sha256 "ee4a662001f1a0804b269b7c625fb4d6886d7d2961e57f7affb425b75c30f385"
    end
  end
