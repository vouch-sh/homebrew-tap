class Vouch < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/vouch-sh/vouch/releases/download/v2026.3.3/vouch-v2026.3.3-aarch64-apple-darwin.tar.gz"
      sha256 "658d5a8dfcdbb9c9f758c303a690f3a98f1eec078cd4f952861554b77216d1ae"
    end
  end
