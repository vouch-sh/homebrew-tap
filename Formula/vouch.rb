class Vouch < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/vouch-sh/vouch/releases/download/v2026.2.32/vouch-v2026.2.32-aarch64-apple-darwin.tar.gz"
      sha256 "f60d96610798f8e0dd5185246e57559ac4d6dfe729aa6bffd211a3d309ccc148"
    end
  end
