class Vouch < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/vouch-sh/vouch/releases/download/v2026.2.4/vouch-v2026.2.4-aarch64-apple-darwin.tar.gz"
      sha256 "fe977991bb90d1f41986e48c9584f67e2d89b19a3fcbade8840ccc9b20b15c3a"
    end
  end
