class Vouch < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/vouch-sh/vouch/releases/download/v2026.7.1/vouch-v2026.7.1-aarch64-apple-darwin.tar.gz"
      sha256 "5680be0b430ea42655cf6c3feb593598dd37e1d2784bcc0275ea152ea88ee84d"
    end
  end
