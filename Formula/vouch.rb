class Vouch < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/vouch-sh/vouch/releases/download/v2026.3.16/vouch-v2026.3.16-aarch64-apple-darwin.tar.gz"
      sha256 "39c2800c25f2ae93857a13882ae1dfd8ce64ec30e167de1115235108c725eb9a"
    end
  end
