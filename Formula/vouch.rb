class Vouch < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/vouch-sh/vouch/releases/download/v2026.2.3/vouch-v2026.2.3-aarch64-apple-darwin.tar.gz"
      sha256 "09a49ca5f2d667c5b7ab71f208c410c2da09081de31bb7a18f5b2192f8ab759b"
    end
  end
