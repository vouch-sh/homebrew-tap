class Vouch < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/vouch-sh/vouch/releases/download/v2026.2.25/vouch-v2026.2.25-aarch64-apple-darwin.tar.gz"
      sha256 "fb71f1b4a27c17ea1f63827dd25216a5ee7bba46d9930aa9cb735492ae52450e"
    end
  end
