class Vouch < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/vouch-sh/vouch/releases/download/v2026.2.11/vouch-v2026.2.11-aarch64-apple-darwin.tar.gz"
      sha256 "42bb4801bfe21333d1f8e34f08df2b2b3026eadd4d74a10681023525842b1d30"
    end
  end
