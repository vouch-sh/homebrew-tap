class Vouch < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/vouch-sh/vouch/releases/download/v2026.3.7/vouch-v2026.3.7-aarch64-apple-darwin.tar.gz"
      sha256 "c2431716b500305faf0a10a0cec842df8fdbca1b4711f221b6a1b942efa1a47e"
    end
  end
