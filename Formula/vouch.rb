class Vouch < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/vouch-sh/vouch/releases/download/v2026.5.3/vouch-v2026.5.3-aarch64-apple-darwin.tar.gz"
      sha256 "b423cd4b79521217f71442a34890ddce849f9b3ed6a67223bf98956fcbd468fb"
    end
  end
