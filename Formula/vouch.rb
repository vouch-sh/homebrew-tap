class Vouch < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/vouch-sh/vouch/releases/download/v2026.3.2/vouch-v2026.3.2-aarch64-apple-darwin.tar.gz"
      sha256 "a2f38c26204002bca0438fad6281c84fdc4dff24c23cff702eb8dd20af637b32"
    end
  end
