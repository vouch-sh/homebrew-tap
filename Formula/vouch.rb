class Vouch < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/vouch-sh/vouch/releases/download/v2026.3.14/vouch-v2026.3.14-aarch64-apple-darwin.tar.gz"
      sha256 "75e47bcf3592d5b1bad997b875d64873263b137f459980fb96c4b30b4f720cc0"
    end
  end
