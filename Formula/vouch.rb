class Vouch < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/vouch-sh/vouch/releases/download/v2026.2.6/vouch-v2026.2.6-aarch64-apple-darwin.tar.gz"
      sha256 "cb706693e6ab93dc8354e2814328b7a9030f970e86678c5085303a3e3814438e"
    end
  end
