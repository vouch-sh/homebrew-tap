class Vouch < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/vouch-sh/vouch/releases/download/v2026.2.47/vouch-v2026.2.47-aarch64-apple-darwin.tar.gz"
      sha256 "888bad8e2cf827d70cc6523464f81c442e34cd376fc017cd8ce87c3cfb9bfc3b"
    end
  end
