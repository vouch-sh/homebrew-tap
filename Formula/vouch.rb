class Vouch < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/vouch-sh/vouch/releases/download/v2026.2.14/vouch-v2026.2.14-aarch64-apple-darwin.tar.gz"
      sha256 "965e53d87baa70667a23706ebc6c7679fc48dd41affad0a8a2cd3f6b4054c190"
    end
  end
