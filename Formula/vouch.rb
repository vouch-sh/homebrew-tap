class Vouch < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/vouch-sh/vouch/releases/download/v2026.4.6/vouch-v2026.4.6-aarch64-apple-darwin.tar.gz"
      sha256 "7a296ba7c22abebe85536360186e9ecd1797d62ef41312a77f6b370446f2ab4d"
    end
  end
