class Vouch < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/vouch-sh/vouch/releases/download/v2026.2.13/vouch-v2026.2.13-aarch64-apple-darwin.tar.gz"
      sha256 "f8c0b08a3571fcca8d4b42f1340605e5ff9c90d98ed04f143d9a6d7a8bc12422"
    end
  end
