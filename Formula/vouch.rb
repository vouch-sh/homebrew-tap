class Vouch < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/vouch-sh/vouch/releases/download/v2026.6.2/vouch-v2026.6.2-aarch64-apple-darwin.tar.gz"
      sha256 "e70cb7cf3e8800e992aba709250094fd0008fdc1945951c595a9b01317915b2f"
    end
  end
