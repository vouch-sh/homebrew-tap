class Vouch < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/vouch-sh/vouch/releases/download/v2026.3.12/vouch-v2026.3.12-aarch64-apple-darwin.tar.gz"
      sha256 "059335b601357d36292e51007635f014d7e2684ec932dca5d46fd16d82076046"
    end
  end
